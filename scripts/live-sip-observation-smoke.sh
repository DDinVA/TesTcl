...
scenario="$repo_root/examples/scenarios/live-sip-17.5.json"
python_bin="$repo_root/.venv/bin/python"
log_file=$(mktemp -t testcl-live-sip.XXXXXX)
server_pid=""
...
request = (
    ...
    b"Call-ID: smoke-options\r\n"
    b"CSeq: 1 OPTIONS\r\n"
    b"Content-Length: 0\r\n\r\n"
)
with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as client:
    client.settimeout(2)
    client.sendto(request, ("127.0.0.1", int(sys.argv[1])))
...
echo "Captured SIP observations:"
