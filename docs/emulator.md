...
packs cover AAA, ACCESS, ADAPT, AUTH, BWC, CACHE, CATEGORY, DHCPv4, DHCPv6, GTP, HTTP, HTTP/2, IKE, LSN, PCP, PSC, DNS, TCP, TLS/SSL, X509, UDP/datagram, WebSocket, XLAT, RTSP, SCTP,
...
current report covers 695 of 989 target F5 commands (70.27%). This is test-input
