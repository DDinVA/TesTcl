...
packs cover AAA, ACCESS, ADAPT, AM, AUTH, BWC, CACHE, CATEGORY, CRYPTO, DHCPv4, DHCPv6, DOSL7, ECA, FLOW, GTP, HTTP, HTTP/2, IKE, LSN, NSH, PCP, PSC, DNS, TCP, TLS/SSL, X509, UDP/datagram, WebSocket, XLAT, RTSP, SCTP,
...
current report covers 736 of 989 target F5 commands (74.42%). This is test-input
