...
packs cover AAA, ACCESS, ADAPT, AM, AUTH, BWC, CACHE, CATEGORY, COMPRESS, CONNECTOR, CRYPTO, DATAGRAM, DHCPv4, DHCPv6, DOSL7, ECA, FLOW, GTP, HTML, HTTP, HTTP/2, IKE, ISTATS, LINK, LSN, NSH, ONECONNECT, POLICY, PCP, PEM, PSM, RADIUS, REWRITE, STATS, TAP, DNS, TCP, TLS/SSL, X509, UDP/datagram, WebSocket, XLAT, RTSP, SCTP,
...
current report covers 802 of 989 target F5 commands (81.09%). This is test-input
