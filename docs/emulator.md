...
packs cover AAA, ACCESS, ADAPT, AUTH, CACHE, CATEGORY, DHCPv4, DHCPv6, GTP, HTTP, HTTP/2, IKE, PSC, DNS, TCP, TLS/SSL, X509, UDP/datagram, WebSocket, RTSP, SCTP,
...
current report covers 661 of 989 target F5 commands (66.84%). This is test-input
